...
%     % L on M
    ...
    chip(1).power(2) = 1.81843502; % Die 1 (TOP) power
    chip(1).power(1) = 17.29691587; %Die 2 (BOTTOM) power
    %chip(1).power(2) = 2.77947487; %Die 2 (BOTTOM) power

    % Testing imported memory map
    die2_map = readmatrix('./3DCIM/memPowermap_2tier_unbalanced.csv'); %TOP DIE
    die1_map = readmatrix('./3DCIM/logicPowermap_2tier.csv'); %Bottom
    %die1_map = [];
    %die2_map = die1_map;
    ...
    chip(1).tsv_map = [0.009506305962395982 0.1E-03 0.01406025098067695 0.021 5.00E-02]; %clustered TSV distribution
