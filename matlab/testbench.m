...
%******************5/4/2023 ***********************************************
% working on implenting polylithic integration testbed - chiplets
% embedded in the BEOL***
%% clear caches
...
period = 1e-9;
system.ggt_ground = 1;
system.bridge_power = 1;
system.bridge.FLAG = iii;
edge = 1e-3;
% 1 stack
system.chip.N = 1;
%% for Chip # 1 parameters %%
% 5 chips stacked on each other
chip(1).N = 5;
chip(1).Xsize = 1e-2; %chip x dimension; y dimension below
chip(1).Ysize = 1e-2;

chip(1).Metal.N = [4 4 4 4 4];
chip(1).Metal.p = [18e-9 27e-9 18e-9 18e-9 18e-9]; % wire resistivity
...
chip(1).Metal.pitch = [160e-9 160e-9 360e-9 30e-6 ...
                        160e-9 160e-9 360e-9 30e-6 ...
                        160e-9 160e-9 360e-9 30e-6 ...
                        160e-9 160e-9 360e-9 30e-6 ...
                        160e-9 160e-9 360e-9 30e-6]*2;
chip(1).Metal.thick = [144e-9 144e-9 324e-9 7e-6 ...
                        144e-9 144e-9 324e-9 7e-6 ...
                        144e-9 144e-9 324e-9 7e-6 ...
                        144e-9 144e-9 324e-9 7e-6 ...
                        144e-9 144e-9 324e-9 7e-6];
                   
chip(1).Via.R = [0.4253 0.4253 0.1890 0 ... 
                 0.4253 0.4253 0.1890 0 ...
                 0.4253 0.4253 0.1890 0 ...
                 0.4253 0.4253 0.1890 0 ...
                 0.4253 0.4253 0.1890 0]*450;
chip(1).Via.N = [4e9 4e9 8e8 1e5 ...
                4e9 4e9 8e8 1e5 ...
                4e9 4e9 8e8 1e5 ...
                4e9 4e9 8e8 1e5 ...
                4e9 4e9 8e8 1e5]/45;

chip(1).cap_per = [0.05 0.05 0.05 0.05 0.05];
chip(1).cap_th = [0.9e-9 0.9e-9 0.9e-9 0.9e-9 0.9e-9]; %capacitance effective thicknee (used for capacitance value calculation)

chip(1).power = [500e-3 500e-3 500e-3 500e-3 5]; %total power dissipation of each die
bank_power = 100e-3;
...
chip(1).tsv_map = [4.7e-3 0.2e-3 0.6e-3 9.6e-3 100e-3 0.05];
% chip(1).power = [80];
% chip(1).map = [];
